...
def transfer_random_audio_files(source_dir, target_dir, num_files=99000):
    ...
    if len(audio_files) < num_files:
        raise ValueError(f"Not enough Audio files in source directory. Found {len(audio_files)}, need {num_files}")
...
def main():
    ...
    target_directory = "src/data/raw/negative"
    files_to_transfer = 1000
